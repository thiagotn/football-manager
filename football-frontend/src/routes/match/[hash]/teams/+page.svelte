  ...
  <main class="relative z-10 max-w-2xl mx-auto px-3 pb-6 pt-3">
    ...
    {:else}
      ...
      <div class="flex gap-2">
        <button onclick={shareTeamsWhatsApp} class="flex-1 btn btn-secondary justify-center gap-2">
          <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="currentColor" class="shrink-0">
