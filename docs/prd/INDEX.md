...
| 044 | [football-api-go.md](044-football-api-go.md) | 🚧 | Port da API rachao.app em Go (Chi + sqlc + pgx/v5) — `/api/v2`, mesmo DB, paridade total de endpoints — Fase 4 completa |
